...
```
After importing the precipitation 2018 and precipitation 2019 data. There are important information that people may want to know. 
1. The total precipitation in 2018 was `r total_precipitation18`. 
2. The total precipitation in 2019 was `r total_precipitation19`. 
3. The median precipitation in 2018 was `r median_p18`. 
4. The median precipitation in 2019 was `r median_p19`. 
5. The mean precipitation in 2018 was `r mean_p18`.
6. The mean precipitation in 2019 was `r mean_p19`. 
7. The total rows in precipitation data in 2018 `r p18_row`.
8. The total rows in precipitation data in 2019 `r p19_row`.
9. The total columns in precipitation data in 2018 `r p18_col`.
10. The total columns in precipitation data in 2019 `r p19_col`.
11. The variables in the precipitation data in 2018 are `r variable_p18`.
12. The variables in the precipitation data in 2019 are `r variable_p19`.
