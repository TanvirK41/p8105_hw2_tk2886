...
### Analysis of Data
```{r}
total_precipitation18 = sum(precipitation18_data$total)
total_precipitation19 = sum(precipitation19_data$total)
```
1. The total precipitation in 2018 was `r total_precipitation18`. 
2. The total precipitation in 2018 was `r total_precipitation19`. 
