...
range_year = pol_data %>% select(year) %>%
  range()

name_stockmarket = stockmark_data %>% names()
dim_stockmarket = stockmark_data %>% dim()
range_year_snp = stockmark_data %>% select(year) %>%
  range()

names_unemployment = unemploy_data %>% names()
names_unemployment = unemploy_data %>% dim()
range_year_unemployment = unemploy_data %>% select(year) %>%
  range()

rangeyear_min
range_year_snp
range_year_unemployment
```
...
### Creating table showing the rank in popularity of the name “Olivia” 
```{r}
olivia_rank <-
