...
The *“snp”* data set contains data that is related to Standard & Poor’s stock market index (S&P), often used as a representative measure of stock market as a whole. The *important variables* in the snp data set are **`r name_stockmarket`**. The *dimensions* of the snp data is **`r dim_stockmarket`**. The *range of years* in the "snp" data is from **`r range_year_snp`**. 
